...
export const AuditAction = {
  ...
  MONTHLY_PERIOD_CREATED: 'MONTHLY_PERIOD_CREATED',
  MONTHLY_ATTENDANCE_CLOSED: 'MONTHLY_ATTENDANCE_CLOSED',

  PAYROLL_CALCULATED: 'PAYROLL_CALCULATED',
  PAYROLL_CALCULATION_BLOCKED: 'PAYROLL_CALCULATION_BLOCKED',
} as const;
